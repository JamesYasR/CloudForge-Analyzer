vcpkg_from_github(
    ...
    PATCHES
        ...
        io_ply.patch
        fix-ply-parser-gcc15.patch # ply_parser.h 别名遮蔽, GCC15 兼容 (overlay)
        fix-sha1-boost186.patch # sha1 get_digest API, boost1.86 兼容 (overlay)
        fix-getclassname.patch # FeatureContainer getClassName 不存在, 硬编码 (overlay)
        fix-poisson4-gcc15.patch # poisson4 模板成员名修正+algorithm头, GCC15 (overlay)
        fix-face-detector-fs.patch # face_detector 缺 boost/filesystem.hpp (overlay)
)
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DWITH_DSSDK=OFF
        -DWITH_ENSENSO=OFF
        -DWITH_OPENMP=ON  # 多线程并行：NormalEstimationOMP / #pragma omp 需要 PCL 编译时启用 OpenMP
        -DWITH_OPENNI=OFF
        -DWITH_PNG=ON
        -DWITH_QHULL=ON
        -DWITH_RSSDK=OFF
